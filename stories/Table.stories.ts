...
MetaData.args = {
  dataSource: [
    { id: 1, name: 'user01', email: 'user01@correo.com' },
    { id: 2, name: 'user02', email: 'user02@correo.com' },
  ],
  metaColumns: [
    { field: 'id', title: 'ID' },
...
TwoColumns.args = {
  dataSource: [
    { name: 'user01', email: 'user01@correo.com' },
    { name: 'user02', email: 'user02@correo.com' },
  ],
  metaColumns: [
    { field: 'name', title: 'Nombre' },
    { field: 'email', title: 'Correo' },
